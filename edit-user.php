                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 mb-3">
                             <div class="form-group">
                                ...
                                autocomplete="off" value ="<?= $user['username'] ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="fullname">Full Name</label>
                                <input type="text" name="fullname"
                                class="form-control" id="fullname" placeholder="masukan nama lengkap user" autofocus
                                autocomplete="off" value ="<?= $user['fullname'] ?>" required>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="level" id="level" class="form-control">
                                    ...
                                    <option value="2" <?= selectUser2($level) ?>>KSPPG</option> 
                                    <option value="3" <?= selectUser3($level) ?>>Akuntan</option> 
                                    <option value="4" <?= selectUser4($level) ?>>Operator</option> 
